        ...
        <VStack spacing={8}>
          <Container borderRadius={3} w={"80%"} h={"80vh"}>
            ...
            <Flex mt={5}>
              ...
              <Input valule={dados.nome} onChange={handleEvent} variant="filled" placeholder="Nome" />
              <Input valule={dados.idade} onChange={handleEvent} ml={4} variant="filled" placeholder="Idade" />
              <Input valule={dados.idade} onChange={handleEvent} ml={4} variant="filled" placeholder="Sexo" />
            </Flex> 
