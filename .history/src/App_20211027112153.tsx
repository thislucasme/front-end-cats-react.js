...
export const App: React.FC = () => {
  ...
  function getAllTeste() {
    useSWR('http://localhost:3000/cats', apiRequest)
  }
        ...
        <Grid minH="100vh" p={3}>
          ...
          <VStack spacing={8}>
            <Container borderRadius={3} w={"80%"} h={"80vh"}>
              ...
              {
                data?.length > 0 ?
                  <Lista gatos={data} error={error} />
                  : <Text color="gray" fontSize={"md"} mt={10}>Nenhum gato foi encontrado no banco de dados</Text>
              }
            </Container>
          </VStack>
        </Grid>
