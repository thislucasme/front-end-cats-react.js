...
function TextInput() {
	...
	return (
		<VStack>
			...
			<Input value={text} placeholder="digite aqui" onChange={ } />
		</VStack>
	);
}
			...
			<VStack w="full">
				...
				<VStack w="50%">
					...
					<Flex w="full" mt={5}>
						...
						<Input value={nome} onChange={(e) => { setNome(e.target.value) }} variant="filled" placeholder="Nome" />
						<Input value={idade} onChange={(e) => { setIdade(e.target.value) }} ml={4} variant="filled" placeholder="Idade" />
						<Input value={sexo} onChange={(e) => { setSexo(e.target.value) }} ml={4} variant="filled" placeholder="Sexo" />
						<Button colorScheme="blue" mx="5">add</Button>
					</Flex>
