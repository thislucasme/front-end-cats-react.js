	...
	return (
		<Center>
			<VStack w="full">
				...
				<VStack w={{ sm: "90%", md: "60%", lg: "40%" }}>
					<Heading>Bem vindo ao login</Heading>
					...
					<HStack><Text>Não possui uma contaa? </Text><Link onClick={() => { openLink('/cadastro/user') }}>criar</Link></HStack>
				</VStack>
			</VStack>
		</Center>
	);
