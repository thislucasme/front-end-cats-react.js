...
export const App = () => {
  ...
  const [dados, setDataSate] = useState({nome: ""});
        ...
        <VStack spacing={8}>
          <Container borderRadius={3} w={"80%"} h={"80vh"}>
            ...
            <Flex mt={5}>
              ...
              <Input value={dados.nome} onchange={(e: React.ChangeEvent<HTMLInputElement>) => {handleEvent(e)}}variant="filled" placeholder="Nome" />
